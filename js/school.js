...
function loadSchoolData(){
    let lambda = document.getElementById("school-tasks");
    ...
    xhr.addEventListener("load", function () {
        ...
        const schoolItems = items.filter(item => item.category === "School");
        const priorityOrder = { "High": 3, "Medium": 2, "Low": 1 };
        schoolItems.sort((a, b) => priorityOrder[b.priority] - priorityOrder[a.priority]);
